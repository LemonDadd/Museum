...
- (void)requestResetPasswordBypasswd:(NSString *)passwd
    ...
    [AllInterfaceRequest requestResetPasswordBypasswd:passwd mobile:mobile validCode:validCode validid:validid request:^(BOOL message, BOOL success, NSString *errorMsg, BOOL error) {
