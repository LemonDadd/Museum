...
- (void)viewDidLoad {
    ...
    UIFont *font = [UIFont fontByName:MFONT fontSize:18];
    ...
    self.subBtn.titleLabel.font = [UIFont fontByName:MFONT fontSize:18];
...
- (void)subBtnEvent {
    ...
    [AllInterfaceRequest requestUpdatePasswordByNewPassword:self.confirmPass.text oldPassword:self.oldPass.text request:^(BOOL message, BOOL success, NSString *errorMsg, BOOL error) {
