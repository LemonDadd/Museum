...
-(void)setUpPlayerView
{
    ...
    {
        self.playerPlaceHolderImg = [[UIImageView alloc]init];
        [self.playerPlaceHolderImg sd_setImageWithURL:[NSURL URLWithString:self.playerPlaceHolderImgName] placeholderImage:[UIImage imageNamed:BigDefault]];
...
-(void)setUpLoadingView
{
    ...
    kWeakSelf(self);
    _loadingView.backBlock = ^{
        [weakself back:weakself.backBtn];
    };
...
-(void)playOption:(ZFTButton *)sender{
    ...
    if (sender.selected) {
        ...
        self.playerPlaceHolderImg.hidden = YES;
        [self.player play];
    }
